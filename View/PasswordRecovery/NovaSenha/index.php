        ...
        <div class="wrapper">
            ...
            <form action="../../../Controller/novaSenha.php" method="GET" class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--6-col mdl-cell--12-col-tablet">
                    <a href="../../../View/Home/index.html"><button type="button" class="mdl-button mdl-js-button mdl-js-ripple-effect" style="color:#16968a;">Cancelar</button></a>
                    <button type="submit " class="salvar" action="../../../Controller/novaSenha.php" method="GET">Salvar</button>
                </div>
            </form>
        </div>
