...
<body>
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--fixed-tabs">
        <header class="mdl-layout__header">
            <div class="mdl-layout__header-row">
                ...
                <div class="material-icons mdl-badge mdl-badge--overlap chat-icon" data-badge="2">chat</div>
            </div>
            <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
                <a href="#fixed-tab-1" class="mdl-layout__tab is-active" id="tab-hire">Contratar</a>
                <a href="#fixed-tab-2" class="mdl-layout__tab" id="tab-progress">Andamento</a>
            </div>
        ...
        <div class="mdl-layout__drawer">
            <div class="profile">
                <img src="img/icons/user-icon.png" alt="profile photo">
                <h5>
                    <?php 
            ...
            <nav class="mdl-navigation">
                <a class="mdl-navigation__link active-menu-link" href="#" id="services-btn">Contratar</a>
                <a class="mdl-navigation__link" href="#" id="work-btn">Prestar Serviço</a>
        ...
        <main class="mdl-layout__content">
                    ...
                    <div class="page-content">
                        <div class="search-wrapper">
                            <div class="mdl-textfield mdl-js-textfield">
                                <input class="mdl-textfield__input" type="text" id="input-search" name="name">
                                <label class="mdl-textfield__label" for="input-search">Digite o serviço que
                                    procura</label>
                            </div>
                            <button
                    ...
                    <div class="page-content">
                        <div class="service-item-wrapper">
                            <div class="service-description">
                                <h4>Arrumar telhado</h4>
                                <p>Conserto de uma Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta pra
                                </p>
                            </div>
                            <div class="status">
                                <img src="img/icons/checked.png" alt="" width="60">
                                <h6>Finalizado</h6>
                            </div>
                        </div>
                        <div class="service-item-wrapper">
                            <div class="service-description">
                                <h4>Arrumar telhado</h4>
                                <p>Conserto de uma telha que foi levada em uma chuva</p>
                            </div>
                            <div class="status">
                                <img src="img/icons/checked.png" alt="" width="60">
                                <h6>Finalizado</h6>
            ...
            <section class="section-page section-page-myAccount">
                <div class="form-wrapper">
                    <form action="../../Controller/editarUser.php" method="POST" class="mdl-grid">
                   ...
                   echo('
                        ...
                        <div class="mdl-cell mdl-cell--7-col mdl-cell--5-col-tablet" style="min-width: 288px; margin: 2em 0;">
                            ...
                            <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="radio-male">
                                        <input type="radio" id="radio-male" class="mdl-radio__button" name="gender" value="M" '.(($row['gender'] == 'M')?'checked':'').'>
                                        <span class="mdl-radio__label">Masculino &ensp;</span>
                                    </label>
                            <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="radio-female">
                                        <input type="radio" id="radio-female" class="mdl-radio__button" name="gender" value="F" '.(($row['gender'] == 'F')?'checked':'').'>
                        ...
                        <div class="mdl-cell mdl-cell--6-col mdl-cell--3-col-tablet">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="max-width: 150px">
                                <input class="mdl-textfield__input" type="text" id="input-phone_number"  name = "phone-number" value="'.$row['phone_number'].'">
                                <label class="mdl-textfield__label" for="input-phone_number">Celular</label>
                            </div>
                        </div>
                        <div class="mdl-cell mdl-cell--12-col">
                            <h5>Endereço</h5>
                        ...
                        <div class="mdl-cell mdl-cell--4-col">
                            ...
                            <SELECT name="estados-brasil">
                                <option value="'.$row['uf'].'" selected>'.$row['uf'].'</option>
                        ...
                        <div class="mdl-cell mdl-cell--3-col">
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 90px">
                                <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="input-number"  name="number" id="input-number" value="'.$row['home_number'].'">
                        ...
                        <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                            <button type="button" class="mdl-button mdl-js-button btn-modalDeleteAccount">
                        ...
                        <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
                            <a href="../../Controller/editarUser.php"><button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" onclick="toggleModalSavedChanges()">Salvar alterações</button></a>
                        </div>'); 
                        ?>
                    </form>
                </div>
            ...
            <section class="section-page section-page-work ">
                <h3>Para se tornar um prestador, é fácil!</h3>
                <div class="cards">
                    <div class="card">
                        <img src="img/icons/search-icon-2.svg" alt="">
                        <h5>Escolha um serviço</h5>
                        <p>Selecione o serviço na qual você se enquadra</p>
                    </div>

                    <div class="card">
                        <img src="img/icons/deal-icon.svg" alt="">
                        <h5>Negocie</h5>
                        <p>Entre em um acordo com o cliente</p>
                    </div>

                    <div class="card">
                        <img src="img/icons/repairing.svg" alt="">
                        <h5>É só trampar!</h5>
                        <p>Depois de tudo pronto, basta prestar o serviço!</p>
                    </div>
                </div>
                <h4>Mas antes, você deve preencher alguns dados:</h4>
                <form action="#">
        ...
        <div class="modal-content">
            ...
            <div class="buttons-wrapper">
                <a href="../../Controller/logout.php"><button
                        class="mdl-button mdl-js-button mdl-js-ripple-effect">Sim</button></a>
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"
                    onclick="toggleModal()">Não</button>
            </div>
        </div>
    </div>

    <!-- modal -->
    <div class="modal-style modal-deleteAccount">
        <!-- Modal content -->
        <div class="modal-content">
            <button class="mdl-button mdl-js-button mdl-button--icon close-modal-style close-modalDeleteAccount">
                <i>&times;</i>
            </button>
            <h3 style="font-size:1.7em"> Deseja excluir sua conta?</h3>
            <div class="buttons-wrapper">
                <a href="../../../Controller/excluirContratante.php"><button
                        class="mdl-button mdl-js-button mdl-js-ripple-effect">Sim</button></a>
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"
                    onclick="toggleModalDeleteAccount()">Não</button>
            </div>
        </div>
    </div>
    ...
    <div class="modal-style modal-changePassword">
        <!-- Modal content -->
        <div class="modal-content">
            <button type="button" class="mdl-button mdl-js-button mdl-button--icon close-modal-style close-changePassword">
                <i>&times;</i>
            </button>
            <h3 style="font-size:1.7em">Alterar senha</h3>
            <form action="../../../Controller/EditarSenhaContratante.php" method="POST" class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col">
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                ...
                <button type="button" class="mdl-button mdl-js-button mdl-js-ripple-effect" onclick="toggleModalChangePassword()">Cancelar</button>
                <a href="../../../Controller/EditarSenhaContratante.php"> <button type="submit"
                        class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Salvar</button></a>
            </form>
        </div>
    </div>

    <!-- modal -->
    <div class="modal-style modal-savedChanges">
        <!-- Modal content -->
        <div class="modal-content">
            <button class="mdl-button mdl-js-button mdl-button--icon close-modal-style close-modal-savedChanges">
                <i>&times;</i>
            </button>
            <h3>Alterações Salvas!</h3>
            <div class="buttons-wrapper">
                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" onclick="toggleModalSavedChanges()">Ok</button>
            </div>
        </div>
    </div>
